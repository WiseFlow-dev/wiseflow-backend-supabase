-- 034_update_peer_averages_rpc_with_spending.sql
-- Update get_peer_averages_by_bracket to include spending_ratio
...
BEGIN
  ...
  WHERE ums.month = p_month
    AND (ums.savings_rate_v2 IS NOT NULL OR ums.spending_ratio IS NOT NULL);
END;
