...
begin
  ...
  perform net.http_post(
    ...
    body := jsonb_build_object('includeProcessed', false),
    timeout_milliseconds := 110000
  );
end;
$$;

revoke all on function public.invoke_policy_eval_cron() from public;
grant execute on function public.invoke_policy_eval_cron() to service_role;
